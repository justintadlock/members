 ...
 * @return array
 */
function has_cap_filter( $allcaps, $caps, $args, $user ) {
 ...
 * @return bool
 */
function has_role( $user_id, $roles = [] ) {
 ...
 * @return bool
 */
function current_has_role( $roles ) {

	return is_user_logged_in() ? has_role( get_current_user_id(), $roles ) : false;
}
 ...
 * @return bool
 */
function current_can_any( $caps = array() ) {
 ...
 * @return bool
 */
function current_can_all( $caps = array() ) {
